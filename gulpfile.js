...
gulp.task('copy-ngidle-keepalive', gulpCommon.copyNgIdleKeepAliveTask);
gulp.task('copy-ngidle-core', gulpCommon.copyNgIdleCoreTask);
gulp.task('copy-angular2-moment', gulpCommon.copyAngular2MomentTask);
gulp.task('copy-moment', gulpCommon.copyMomentTask);
